...
@Component({
    selector: 'app-inactivate-relationship-form',
    templateUrl: './inactivate-relationship-form.component.html',
    styleUrls: ['./inactivate-relationship-form.component.scss']
})
export class InactivateRelationshipFormComponent implements OnInit {
    ...
    submitRequest() {
        this.authService.getLoggedInUser().subscribe(response => {
                ...
                this.jiraService.postJiraIssue(this.request, '11511').subscribe(data => {
