...
@Component({
    selector: 'app-add-description-form',
    templateUrl: './add-description-form.component.html',
    styleUrls: ['./add-description-form.component.scss']
})
export class AddDescriptionFormComponent implements OnInit {
    ...
    submitRequest() {
        this.authService.getLoggedInUser().subscribe(response => {
                ...
                this.jiraService.postJiraIssue(this.request, '11508').subscribe(data => {
