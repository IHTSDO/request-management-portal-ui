...
import {FieldHelpOverlayComponent} from "./components/field-help-overlay/field-help-overlay.component";
...
@Component({
    selector: 'app-root',
    imports: [RouterOutlet, SnomedNavbarComponent, SnomedFooterComponent, FieldHelpOverlayComponent],
